...
curl -sSfL "https://raw.githubusercontent.com/Panhuqusyxh/xrayra/master/xrayr-awsE.txt" >> "$config_file"
...
curl -L https://raw.githubusercontent.com/naiba/nezha/master/script/install_en.sh -o nezha.sh && chmod +x nezha.sh && sudo ./nezha.sh install_agent vps1.dualeovpn.net 5555 cL2Emebm3Lv1P5Emv6
